...
if __name__ == "__main__":
    predict(
        source="mmyolo/data/asdr6-2-200-split82/images/",
        model_path="mmyolo/models/yolov5_s-p6-v62_syncbn_fast_4xb8-130e_asdr6-2-200-split82_1280_anchOptm.pth",
        model_config_path="mmyolo/configs/yolov5/yolov5_s-p6-v62_syncbn_fast_4xb8-150e_asdr6-2-200-split82_1280_anchOptm.py",
        model_type="mmdetcustom",
        export_pickle=True,
        dataset_json_path="mmyolo/data/asdr6-2-200-split82/annotations/val.json",
        model_device="cuda",
        slice_height=1024,
        slice_width=1024,
